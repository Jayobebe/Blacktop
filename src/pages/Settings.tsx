...
export default function Settings() {
  ...
  const { settings, toggleSpeedRankings, toggleSpeedUnit, toggleDistanceUnit, setAccentColor, updateSetting, toggleStatsOverlay, toggleLeanAngle, setLeanAngleThreshold } = useSettings();
