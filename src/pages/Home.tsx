        ...
        <div className="flex-1 flex flex-col gap-3 animate-slide-up delay-200">
          ...
          <div className="flex gap-3 flex-1 min-h-[72px] landscape:min-h-0">
            <button
              ...
              className="flex-1 bg-transparent border-[3px] border-accent text-accent hover:bg-accent/10 rounded-2xl flex flex-col items-center justify-center gap-2 transition-all duration-200 hover:shadow-glow active:scale-[0.99] touch-target-lg py-4"
            >
            ...
            <button
              ...
              className="flex-1 bg-transparent border-[3px] border-muted-foreground/50 text-foreground hover:bg-muted/30 rounded-2xl flex flex-col items-center justify-center gap-2 transition-all duration-200 active:scale-[0.99] touch-target-lg py-4"
            >
