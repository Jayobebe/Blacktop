  ...
  return (
    <div className="min-h-screen flex flex-col p-4 safe-top safe-bottom landscape-compact md:p-6 lg:p-8">
      ...
      <div className="flex-1 flex flex-col lg:flex-row gap-4 lg:gap-6">
        ...
        <div className="flex-1 flex flex-col md:flex-row lg:flex-col gap-4 animate-slide-up delay-100">
          <Button
            onClick={() => navigate('/create-convoy')}
            className="flex-1 h-auto min-h-[100px] md:min-h-[120px] text-xl font-display font-bold bg-accent hover:bg-accent/90 text-accent-foreground touch-target-lg"
          >
            <div className="flex flex-col items-center gap-2">
              <Users className="w-10 h-10" />
              <span>START CONVOY</span>
              <span className="text-xs font-normal opacity-80 landscape-hidden">Create a new convoy</span>
            </div>
          </Button>
          ...
          <Button
            ...
            variant="outline"
            className="flex-1 h-auto min-h-[80px] md:min-h-[100px] text-lg font-display font-semibold border-2 hover:bg-secondary touch-target-lg"
          >
            <div className="flex flex-col items-center gap-2">
              <UserPlus className="w-8 h-8" />
              <span>JOIN CONVOY</span>
              <span className="text-xs text-muted-foreground font-normal landscape-hidden">Enter a convoy code</span>
            </div>
          </Button>
        </div>
      </div>
